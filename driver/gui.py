...
UPDATE_INTERVAL = 30  # 300 seconds = 5 minutes
...
def submit_email():
    ...
    if not is_valid_email(email):
        ...
        try:
            ...
            messagebox.showinfo("Success", "Your system information and health is being gathered and sent to your dashboard every 5 minutes")
